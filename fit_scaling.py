...
def run(
    ...
    **kwargs,
    ...
    # Initialize datasets
    dataset = val_data_provider.get_dataset("val")
...
if __name__ == "__main__":
    ...
    config_path = "/nfs/homedirs/beckerf/gemnet_tf/config.yaml"

    nBatches = 25  ## number of batches to use to fit a single variable
    config = get_configs(config_path)[0]

    config["scale_file"] = "/nfs/homedirs/beckerf/gemnet_tf/scaling_factors.json"
